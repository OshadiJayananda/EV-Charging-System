...
const OperatorBookings = () => {
  ...
  const displayedBookings = view === "today" ? todayBookings : upcomingBookings;
              ...
              {displayedBookings.length === 0 ? (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                  {displayedBookings.map((booking) => {
                    ...
                    const isProcessing = processingBooking === booking.bookingId;
                      ...
                      >
                        <div className="flex items-start justify-between mb-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <div className="font-semibold text-gray-900">Slot {booking.slotNumber}</div>
                              <div className="text-sm text-gray-600">{booking.connectorType}</div>
                            </div>
                          </div>
                          <div className={`flex items-center gap-2 px-3 py-1 rounded-full border text-sm font-medium ${statusInfo.badge}`}>
                            {statusInfo.icon}
                            {booking.status}
                          </div>
                        </div>
                        ...
                        <div className="space-y-3 mb-4">
                          <div className="flex items-center gap-2 text-sm text-gray-600">
                            ...
                            <span>{booking.ownerName || booking.ownerId.substring(0, 8)}</span>
                          </div>
                        ...
                        <div className="flex gap-2">
                          ...
                          {(booking.status.toLowerCase() === "finalized" || booking.status.toLowerCase() === "completed") && (
        ...
        <div className="mt-6 bg-blue-50 border border-blue-200 rounded-xl p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 text-sm">
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                <strong className="block text-red-700">Canceled</strong>
                <span className="text-gray-600">Booking canceled</span>
              </div>
            </div>
          </div>
        </div>
